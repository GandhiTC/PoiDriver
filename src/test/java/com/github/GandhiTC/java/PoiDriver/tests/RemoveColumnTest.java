...
public class RemoveColumnTest
{
	public static void main(String[] args)
	{
		...
		System.out.println("Remove a column from selected sheet (current sheet if none selected).");
		System.out.println("Numerous overrides planned to be added.");
		poiDriver.removeColumn("d");
		System.out.println("\r\n");
		...
		System.out.println("\r\nCheck out the .xlsx file to see the changes made, afterwards, close the file and try running PredefinedColorsTest.");
	}
}
